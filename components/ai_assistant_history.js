...
function sendNewMessagePair(role, content, outputElement) 
{
    let AIResponse = "";
    ...
    .catch(error => {
        ...
        outputElement.innerHTML = `<strong style="color:rgb(255, 0, 0)">Error:</strong> ${error.message}. Please try repeating the question`
    });
}

export {sendNewMessagePair}